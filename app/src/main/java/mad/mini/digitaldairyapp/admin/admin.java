package mad.mini.digitaldairyapp.admin;
...
import mad.mini.digitaldairyapp.databinding.AdminBinding;
...
public class admin extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAppBarConfiguration = new AppBarConfiguration.Builder(
                R.id.nav_admin_home, R.id.nav_entry, R.id.nav_edit_entry, R.id.nav_admin_signup, R.id.nav_admin_trace)
